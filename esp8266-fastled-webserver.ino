...
void setup() {
  ...
  FastLED.addLeds<LED_TYPE, D5, COLOR_ORDER>(leds,   0, 504).setCorrection(TypicalLEDStrip);
  FastLED.addLeds<LED_TYPE, D6, COLOR_ORDER>(leds, 503, 168).setCorrection(TypicalLEDStrip);
